...
function Windo(id,parentNode,width,height,transX,transY,moveable,constrXmin,constrYmin,constrXmax,constrYmax,showContent,placeholderStyles,windowStyles,margin,titleBarVisible,statusBarVisible,titleText,statusText,closeButton,minimizeButton,maximizeButton,titlebarStyles,titlebarHeight,statusbarStyles,statusbarHeight,titletextStyles,statustextStyles,buttonStyles,functionToCall) {
	var nrArguments = 30;
...
//create a new window
Windo.prototype.createWindow = function() {
...
Windo.prototype.testParent = function() {
...
Windo.prototype.handleEvent = function(evt) {
    if (evt.type == "click") {
...
Windo.prototype.fireFunction = function(evtType) {
...
Windo.prototype.stopDrag = function() {
...
//minimize a window
Windo.prototype.minimize = function(fireFunction) {
	this.windowMainGroup.setAttributeNS(null,"display","none");
...
//maximize a window
Windo.prototype.maximize = function(fireFunction) {
	this.windowMainGroup.setAttributeNS(null,"display","inherit");
	if (this.decorationGroupMinimized) {
...
Windo.prototype.close = function(fireFunction) {
...
Windo.prototype.open = function(fireFunction) {
	if (!this.removed) {
...
Windo.prototype.resize = function(width,height,fireFunction) {
	this.width = width;
	this.height = height;
	//adopt shadow rect
	this.shadowRect.setAttributeNS(null,"width",this.width);
...
//remove window
Windo.prototype.remove = function(fireFunction) {
	if (!this.removed) {
...
Windo.prototype.setStatusText = function(statusText) {
	if (this.statusBarVisible) {
        this.statusText = statusText;
        if (this.statusText.length > 0) {
...
//change content of statusBar
Windo.prototype.setTitleText = function(titleText) {
	this.titleText = titleText;
...
Windo.prototype.moveTo = function(coordx,coordy,fireFunction) {
	this.transX = coordx;
	this.transY = coordy;
	//check constraints
	if (this.transX < this.constrXmin) {
...
Windo.prototype.appendContent = function(node,inheritDisplay) {
...
Windo.prototype.removeContent = function(node) {
	if (typeof(node) == "string") {
		node = document.getElementById(node);
	}
...
//remove new content from the window main group
Windo.prototype.insertContentBefore = function(node,referenceNode,inheritDisplay) {
	if (typeof(node) == "string") {
		node = document.getElementById(node);
	}
...
Windo.prototype.hideContents = function() {
	this.windowContentGroup.setAttributeNS(null,"display","none");
}

//show content of Window
Windo.prototype.showContents = function() {
	this.windowContentGroup.setAttributeNS(null,"display","inherit");
}

//add window decoration
Windo.prototype.addWindowDecoration = function(node,mayTriggerMoving,topOrBottom) {
	if (typeof(node) == "string") {
		node = document.getElementById(node);
	}
	if (this.decorationGroup) {
