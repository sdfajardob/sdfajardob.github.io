...
// NEW Functions
combobox.prototype.disableCombobox = function() {
	var doNothing = function(){};
	this.functionToCall = doNothing();
	
	//this.createOrUpdateCombobox();
}
combobox.prototype.enableCombobox = function(func_name) {
	
	this.functionToCall = func_name;
	//this.createOrUpdateCombobox();
